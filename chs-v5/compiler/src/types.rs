...
impl TypeDatabase {
    ...
    pub fn fn_pointer(&mut self, params: Vec<TypeID>, return_type: TypeID) -> TypeID {
        let ty = Type::FnPointer { params, return_type };
    ...
    pub fn unify(&mut self, id1: TypeID, id2: TypeID) -> Result<(), String> {
        ...
        match (
            ...
            (Type::FnPointer { params: params1, return_type: ret1 }, Type::FnPointer { params: params2, return_type: ret2 }) => {
    ...
    pub fn type_to_string(&self, id: TypeID) -> String {
        ...
        match self.get_type(canonical) {
            ...
            Type::FnPointer { params, return_type } => {
                ...
                format!("fn({}) -> {}", params_str.join(", "), self.type_to_string(*return_type))
            }
        }
    }
}
